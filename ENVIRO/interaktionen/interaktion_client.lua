...
{"Wannabe","Untertane","Gettofreak","Dealer","Underboss","Big Boss"},
{"Praktikant","Anzeiger","Reporter","Chefreporter","Redakteur","Chefredakteur"},
{"Praktikant","Freiarbeiter","Angestellter","Abteilungsleiter","Vice-Direktor","Direktor"},
{"Rekrut","Mitarbeiter","Agent","Special-Agent","SEK Vice-Präsident","SEK Präsident"},
{"Wannabe","Untertane","Waffenhängst","Unterdrücker","Underboss","Big Boss"},
{"Rekrut","Fähnrich","Ausbilder","Hauptausbilder","Oberleutnant","General"},
{"Rekrut","Anwärter","Mitglied","Intrigant","Geschäftsführer","Firmenchef"},
{"Rekrut","Officer","Sergeant","Inspector","Superintendent","Chief"},
{"Krankenwagenfahrer","Krankenhelfer","Sanitäter","Arzthelfer","Notarzt","Chefarzt"},
{"Anwärter","Wachhund","Rausschmeißer","Geldeintreiber","Underboss","Big Boss"},
{"Wannabe","Untertane","Gettofreak","Dealer","Underboss","Big Boss"}
}
